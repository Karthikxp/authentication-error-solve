...
export function AuthenticationError({ error, onRetry }: AuthenticationErrorProps) {
  const { reAuthenticate, isInitializing } = useAuthState();
        ...
        <ActionPanel>
          ...
          <Action
            ...
            onAction={() => {
              ...
              require('child_process').exec('open https://open.spotify.com');
            }}
          />
        </ActionPanel>
      }
...
export function withAuthenticationError<T extends Record<string, any>>(
